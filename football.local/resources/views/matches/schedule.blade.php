...
@section('title', 'Расписание матчей - Футбольная Лига')
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-lg text-gray-600">Предстоящие матчи сезона</p>
    </div>

    <div class="flex justify-center mb-8">
        <div class="bg-white rounded-lg shadow-md p-1 flex space-x-1">
            <a href="{{ route('schedule') }}" class="px-4 py-2 rounded-md bg-gradient-to-r from-blue-500 to-green-500 text-white transition">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Нет предстоящих матчей</h3>
            <p class="text-gray-600">Расписание матчей будет обновлено позже.</p>
        </div>
        @endforelse
    </div>
