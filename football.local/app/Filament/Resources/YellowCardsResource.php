...
use App\Filament\Resources\YellowCardsResource\Pages;
...
class YellowCardsResource extends Resource
{
    protected static ?string $model = YellowCards::class;
    protected static ?string $navigationIcon = 'heroicon-o-exclamation-triangle';
    protected static ?string $navigationLabel = 'Желтые карточки';
    protected static ?string $modelLabel = 'желтая карточка';
    protected static ?string $pluralModelLabel = 'Желтые карточки';
    ...
    {
        return [
            'index' => Pages\ListYellowCards::route('/'),
            'create' => Pages\CreateYellowCards::route('/create'),
            'edit' => Pages\EditYellowCards::route('/{record}/edit'),
        ];
    }
}